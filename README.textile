...
For _Ubuntu 13.10_ just run: @sudo apt-get install mongodb-server nodejs npm@
...
I use _Web Developer_ extension in Firefox to get it. I tried to automate this step but without any luck.
